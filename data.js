...
const DATA = {
  atualizadoEm: "2026-06-25T08:00:00-03:00",
      ...
      jogos: [
        {
          ...
          local: "MetLife Stadium, East Rutherford (Nova York)",
          placar: null,
          stats: "GER 6pts (1.º garantido, busca campanha perfeita); EQU 1pt (PRECISA vencer para avançar). Undav é o artilheiro da Copa pelo ritmo: 3G em 58 min, incluindo bisse de sub vs CIV. Musiala, Havertz e Wirtz completam o quarteto ofensivo alemão.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Alemanha não perde (dupla hipótese)", odd: 1.28, resultado: null,
              justificativa: "P(ALE+EMP)=77,7%. Alemanha imbatível na Copa (7-1 vs CUR, 2-1 vs CIV). EQU sem vitória ainda — derrota 0-1 vs CIV no R1, empate 0-0 vs CUR no R2. Nagelsmann busca o histórico 3V/3J." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.22, resultado: null,
              justificativa: "λ_total=3,33 — EQU obrigado a atacar (1pt) abre espaço para o contra-golpe alemão. P(≥2 gols)≈84,4% pelo modelo de Poisson com médias combinadas." },
            { cat: "conservadora", mercado: "Alemanha marca no 1T", odd: 1.55, resultado: null,
              justificativa: "ALE abriu 3-0 ainda no 1T vs CUR. Com EQU forçado a avançar a linha para vencer, haverá espaços para transições alemãs cedo. P(ALE≥1 no 1T)≈65% com λ_ALE=2,09." },
            { cat: "intermediaria", mercado: "Alemanha vence", odd: 1.75, resultado: null,
              justificativa: "pV=56,8%. EQU vai apostar tudo no ataque por obrigação — abre espaço para Undav, Musiala e Wirtz decidirem no contra. Alemanha com motivação de campanha perfeita em Copa do Mundo." },
            { cat: "intermediaria", mercado: "Deniz Undav marca", odd: 2.20, resultado: null,
              justificativa: "Artilheiro da Copa pelo ritmo: 3G em 58 min, bisou em 26 min como sub vs CIV. Havertz é titular no 9 mas Undav entrando pode ser decisivo outra vez. λ_ALE=2,09 projeta espaço." },
            { cat: "intermediaria", mercado: "Jamal Musiala marca ou dá assistência", odd: 2.00, resultado: null,
              justificativa: "Musiala 1G no 7-1 vs CUR e em grande fase. É o criativo central — dribla, finaliza e cria. EQU recuando para eventual vantagem dá espaço na meia-lua. Ação direta provável." },
            { cat: "loucura", mercado: "Alemanha −1.5 handicap (vence por 2+)", odd: 2.50, resultado: null,
              justificativa: "Com λ_ALE=2,09 e EQU obrigado a abrir o jogo, vitória alemã ampla é plausível. Se ALE abre 1-0, EQU vai ao tudo-ou-nada e cede ainda mais espaço — Undav do banco pode selar." },
            { cat: "loucura", mercado: "Florian Wirtz marca", odd: 3.50, resultado: null,
              justificativa: "Wirtz, 21 anos (18G+15A pelo Leverkusen na Bundesliga), ainda sem gols na Copa. EQU forçado a avançar cria os espaços nas costas da linha que Wirtz explora pela meia-esquerda." },
            { cat: "loucura", mercado: "Equador marca + Alemanha vence", odd: 2.80, resultado: null,
              justificativa: "EQU ataca por obrigação — λ_EQU=1,24 sugere que marcarão. Mas ALE tem qualidade para vencer mesmo cedendo gol: resultado tipo 2-1 ou 3-1 tem P≈40% pelos dois eventos combinados." }
          ]
        },
        {
          hora: "17h",
          ...
          local: "Lincoln Financial Field, Philadelphia",
          placar: null,
          stats: "CIV (3pts) avança até com empate — sua vitória no R1 vs EQU (1-0) garante H2H favorável em qualquer cenário. CUR (1pt) PRECISA vencer. Amad Diallo marcou o único gol da CIV (sub 90' vs EQU); Kessié abriu o placar vs GER (30'). CIV sem Haller no plantel.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Costa do Marfim não perde (dupla hipótese)", odd: 1.12, resultado: null,
              justificativa: "P(CIV+EMP)=91,9%. Curaçao marcou apenas 1 gol na Copa (Curiel vs ALE antes da goleada) e 0 vs EQU. CIV com motivação total para fechar o grupo em 2.º — avança com qualquer resultado." },
            { cat: "conservadora", mercado: "Costa do Marfim marca", odd: 1.18, resultado: null,
              justificativa: "λ_CIV=2,10 com atacantes de nível: Diallo (gol decisivo vs EQU), Pepe (Nice) e Kessié (motor do meio). Curaçao cedeu 7 gols vs Alemanha. P(CIV≥1)≈87,8%." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.40, resultado: null,
              justificativa: "λ_total=2,63. CIV vai pressionar; CUR precisando vencer deve sair também, abrindo espaços. P(≥2 gols)≈73,9% pelo modelo Poisson." },
            { cat: "intermediaria", mercado: "Costa do Marfim vence", odd: 1.35, resultado: null,
              justificativa: "pV=74,1% — maior probabilidade isolada de vitória dos 6 jogos de hoje. CUR foi goleada 1-7 pela mesma Alemanha que a CIV perdeu apenas 1-2. Diferença de qualidade explícita." },
            { cat: "intermediaria", mercado: "Amad Diallo marca ou dá assistência", odd: 2.30, resultado: null,
              justificativa: "Diallo foi o decisivo da CIV: gol no 90' vs EQU como sub assistido por Singo. Extremo do Manchester United quer confirmar espaço para o mata-mata. CUR cede buracos na defesa alta." },
            { cat: "intermediaria", mercado: "Over 2.5 gols", odd: 1.95, resultado: null,
              justificativa: "λ_total=2,63 e CUR precisa marcar (obrigado a vencer). Se CUR atacar, abre para contra-ataques de CIV. P(≥3 gols)≈49% — o jogo pode ficar mais aberto do que parece." },
            { cat: "loucura", mercado: "Costa do Marfim vence a zero", odd: 2.25, resultado: null,
              justificativa: "λ_CUR=0,53 — a menor expectativa ofensiva dos 6 jogos de hoje. P(CIV vence) × P(CUR=0) ≈ 74,1% × 58,9% ≈ 43,6%: odds 2,25 ligeiramente acima do valor justo de 2,29. Valor claro." },
            { cat: "loucura", mercado: "Nicolas Pepe marca", odd: 3.50, resultado: null,
              justificativa: "Pepe (Nice) ainda não marcou na Copa — Kessié e Diallo dominaram as participações. Vs CUR com a pior defesa do Grupo E, o espaço para Pepe finalizar é real e as odds refletem o hiato de visibilidade." },
            { cat: "loucura", mercado: "Curaçao marca + CIV vence", odd: 4.50, resultado: null,
              justificativa: "CUR marcou vs ALE no 31' antes da goleada. Com mesma dinâmica (CUR tenta, CIV responde e vence), teríamos o enredo do R1 invertido. P(CUR≥1) × P(CIV vence) ≈ 41% × 74% ≈ 30,5%: valor nas odds." }
          ]
        },
        {
          hora: "20h",
          ...
          local: "AT&T Stadium, Arlington (Dallas)",
          placar: null,
          stats: "JPN 4pts (avança com empate), SWE 3pts (PRECISA VENCER). Gyokeres (21G em 35 jogos pela Suécia, Arsenal) e Isak (18G, Liverpool) são o melhor par de atacantes do torneio. Japão: 9 jogos sem perder, goleou TUN 4-0 no R2 e é o melhor no contra-ataque da Copa.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Japão não perde (dupla hipótese)", odd: 1.35, resultado: null,
              justificativa: "P(JPN+EMP)=73,6%. JPN avança com empate e vai defender e contra-atacar. SWE vem de derrota 1-5 vs HOL com defesa exposta. Táticas japonesas favorecem o resultado protegido." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.45, resultado: null,
              justificativa: "λ_total=2,69. SWE PRECISA atacar — abre espaço para o contra-golpe japonês veloz. JPN goleou TUN 4-0 no R2. P(≥2 gols)≈74,9%." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.80, resultado: null,
              justificativa: "P(JPN≥1)≈80%, P(SWE≥1)≈67%. Suécia atacará com Gyokeres+Isak por necessidade. Japão em contra-golpe com Minamino e Kamada. Dinâmica ataque-bloqueio-contra produce gols dos dois lados. P≈53%." },
            { cat: "intermediaria", mercado: "Viktor Gyokeres marca", odd: 2.90, resultado: null,
              justificativa: "Gyokeres: 21G/35 jogos pela Suécia. Marcou vs TUN no R1 com máscara após fratura nasal. Precisa do gol mais que nunca — é o pino central do ataque sueco que vai pressionar 90 min." },
            { cat: "intermediaria", mercado: "Alexander Isak marca", odd: 3.20, resultado: null,
              justificativa: "Isak (Liverpool, 18G/60 caps) marcou no R1 vs TUN. Com defesa japonesa concentrada em Gyokeres, Isak pode encontrar espaços pela segunda linha. Duo marcou 3G juntos no R1." },
            { cat: "intermediaria", mercado: "Suécia vence", odd: 3.50, resultado: null,
              justificativa: "pV=26,4% pelo modelo, mas o must-win é o maior catalisador do futebol. Gyokeres+Isak são o melhor par de atacantes do torneio. Se SWE marcar primeiro, a dinâmica muda: JPN não pode mais sentar no resultado." },
            { cat: "loucura", mercado: "Japão vence a zero", odd: 6.00, resultado: null,
              justificativa: "Japão é o time defensivo do torneio: goleou TUN 4-0 com bloqueio organizado. P(JPN vence) × P(SWE=0) ≈ 48,6% × 33,3% ≈ 16,2%. Com Gyokeres e Isak, improvável — mas a capacidade existe." },
            { cat: "loucura", mercado: "Gyokeres e Isak ambos marcam", odd: 10.00, resultado: null,
              justificativa: "Marcaram no mesmo jogo vs TUN no R1 (5-1). Se a Suécia precisar de uma goleada, os dois vão disputar para inflar o saldo. P≈34%×30%≈10% — exatamente o que as odds refletem." },
            { cat: "loucura", mercado: "Suécia vence + over 2.5 gols", odd: 6.50, resultado: null,
              justificativa: "Se SWE vencer, será em jogo aberto: JPN também contra-ataca com Minamino. Vitória sueca + 3+ gols é o cenário dos must-win abertos. P≈26%×60%≈16% — valor nas odds para apostadores contrários." }
          ]
        },
        {
          hora: "20h",
          ...
          placar: null,
          stats: "TUN 0pts (eliminada, demitiu o técnico após R2, cedeu 9 gols em 2 partidas). HOL 4pts (avança, disputa 1.º se SWE bater JPN). Gakpo e Brobbey bisaram vs SWE (2G cada no torneio). Gakpo a 2 gols do recorde holandês em grandes torneios.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Holanda não perde (dupla hipótese)", odd: 1.10, resultado: null,
              justificativa: "P(HOL+EMP)=94,8%. TUN desmoralizada: 0-9 em gols (média 4,5 sofridos/jogo), demitiu o técnico. HOL em ótima forma com 7G em 2 jogos. A maior probabilidade de não-derrota dos 6 jogos." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.42, resultado: null,
              justificativa: "λ_total=2,72 com HOL projetando 2,30 gols só para si. TUN cedeu 4,5 gols/jogo. Gakpo, Brobbey e Summerville (todos com 2G no torneio) em fina forma. P(≥2 gols)≈75,1%." },
            { cat: "conservadora", mercado: "Holanda vence a zero", odd: 1.90, resultado: null,
              justificativa: "TUN não marcou em 2 jogos (9 gols cedidos). λ_TUN=0,42 — a menor expectativa ofensiva dos 6 jogos de hoje. P(HOL vence) × P(TUN=0) ≈ 80,1% × 65,7% ≈ 52,6%: valor claro." },
            { cat: "intermediaria", mercado: "Holanda vence", odd: 1.25, resultado: null,
              justificativa: "pV=80,1% — a maior probabilidade de vitória do dia. TUN sem treinador e com defesa furada. HOL quer garantir a liderança do Grupo F se SWE bater JPN — vai a campo com intensidade total." },
            { cat: "intermediaria", mercado: "Cody Gakpo marca", odd: 2.20, resultado: null,
              justificativa: "Gakpo bisou vs SWE (47', 54') e está a 2 gols do recorde holandês em grandes torneios. TUN cedeu 4,5G/jogo — contexto ideal para o atacante do Liverpool alcançar a marca histórica." },
            { cat: "intermediaria", mercado: "Brian Brobbey marca", odd: 2.30, resultado: null,
              justificativa: "Brobbey bisou como sub vs SWE (65', 68') em 25 min de jogo. É o centroavante de impacto de Koeman. Com TUN defensivamente frágil, Brobbey pode ter início mais cedo desta vez." },
            { cat: "loucura", mercado: "Holanda marca 3 ou mais gols", odd: 2.50, resultado: null,
              justificativa: "HOL fez 5 vs SWE que havia feito 5 vs TUN. P(HOL≥3) ≈ 40,5% com λ_HOL=2,30. Gakpo+Brobbey+Summerville podem inflar facilmente vs a pior defesa do dia. Odds com margem de valor." },
            { cat: "loucura", mercado: "Gakpo e Brobbey ambos marcam", odd: 5.50, resultado: null,
              justificativa: "Bisaram no mesmo jogo vs SWE (Gakpo 47', 54'; Brobbey sub 65', 68'). Vs TUN que não sustenta nenhuma pressão, repetir é factível. P≈46%×40%≈18%: valor para o risco." },
            { cat: "loucura", mercado: "Holanda −2.5 handicap (vence por 3+)", odd: 3.00, resultado: null,
              justificativa: "HOL fez 5 vs SWE que havia feito 5 vs TUN — cadeia transitiva sugere goleada também aqui. P(HOL vence por ≥3)≈35%. TUN cedeu 4,5G/jogo. Odd 3,00 com valor histórico dado o contexto de forma." }
          ]
        },
        {
          hora: "23h",
          ...
          placar: null,
          stats: "PAR (3pts, DG −2) PRECISA VENCER; AUS (3pts, DG 0) avança com empate. Almiron suspenso (vermelho por cobrir a boca em confronto vs TUR). PAR sem o capitão: Enciso e Pitta à frente, Galarza no meio (gol mais rápido da Copa 2026: 64s vs TUR). Árbitro: Clement Turpin (FRA). H2H: AUS 2V 3E 0D vs PAR.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Paraguai não perde (dupla hipótese)", odd: 1.35, resultado: null,
              justificativa: "P(PAR+EMP)=75,5%. PAR tem qualidade sem Almiron: Enciso (Brighton), Pitta e Galarza formam ataque competente. Atenção: empate elimina o Paraguai — mas para apostas a dupla hipótese tem valor." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.45, resultado: null,
              justificativa: "λ_total=2,67. PAR PRECISA marcar e vencer — vai ao ataque desde o 1'. AUS em contra-ataque com Irankunda e Volpato. Jogo aberto por necessidade paraguaia. P(≥2)≈74,7%." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.80, resultado: null,
              justificativa: "P(PAR≥1)≈80%, P(AUS≥1)≈65%. PAR atacando para sair do impasse sem Almiron; AUS em contra-golpe com Irankunda rápido. A necessidade paraguaia estimula os dois lados. P≈52%." },
            { cat: "intermediaria", mercado: "Paraguai vence", odd: 2.05, resultado: null,
              justificativa: "pM=50,7% — o mais equilibrado dos 3 jogos simultâneos. PAR vai com tudo: Enciso (22 anos, Brighton) como criativo e Pitta no 9. Almiron faz falta mas o grupo tem identidade própria." },
            { cat: "intermediaria", mercado: "Júlio Enciso marca", odd: 3.00, resultado: null,
              justificativa: "Com Almiron suspenso, Enciso herda a responsabilidade criativa do Paraguai. É o jogador mais capaz de criar algo do nada — finta, finaliza e tem nível Premier League. Contexto ideal para sua estreia decisiva." },
            { cat: "intermediaria", mercado: "Matias Galarza marca", odd: 3.00, resultado: null,
              justificativa: "Galarza marcou o gol mais rápido da Copa 2026 (64s vs TUR). Meia de caixa com chegada ofensiva que PAR vai usar para romper bloqueio australiano. Timing cedo e finalizações de meia distância são suas forças." },
            { cat: "loucura", mercado: "Paraguai vence a zero", odd: 5.50, resultado: null,
              justificativa: "P(PAR vence) × P(AUS=0) ≈ 50,7% × 35,0% ≈ 17,8%. AUS tem Irankunda e Volpato perigosos no contra. Mas Gill (goleiro) foi sólido no R2 vs TUR. Odds 5,50 com margem para o improvável." },
            { cat: "loucura", mercado: "Austrália vence", odd: 4.00, resultado: null,
              justificativa: "pV=24,5% e H2H histórico: AUS NUNCA perdeu para o Paraguai (2V 3E). AUS avança até empatando — portanto pode jogar recuada e esperar o erro paraguaio. Irankunda e Volpato em contra-golpe podem decidir." },
            { cat: "loucura", mercado: "Galarza gol no 1T", odd: 7.00, resultado: null,
              justificativa: "Galarza marcou em 64 segundos no R2 vs TUR. PAR vai sair para o ataque desde o apito — se o meia de caixa chegou em 64s no R2, pode chegar cedo no R3 também. P≈15%: odd 7,00 tem valor narrativo." }
          ]
        },
        {
          hora: "23h",
          ...
          local: "SoFi Stadium, Los Angeles (Inglewood)",
          placar: null,
          stats: "TUR 0pts (eliminada, 0G em 40+ finalizações em 2 jogos!). EUA 6pts (1.º garantido), vai rodar — Adams, Balogun, Robinson e Richards em risco de suspensão (cartão amarelo). Pulisic retorna ao treino após lesão no calf. Kenan Yildiz (Juventus, 21 anos) esperado como titular turco.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "EUA não perde (dupla hipótese)", odd: 1.45, resultado: null,
              justificativa: "P(EUA+EMP)=69,4%. EUA rota mas tem bench de qualidade (Reyna, Ferreira, Sargent). TUR marcou 0 gols em 2 jogos vs adversários de nível inferior. Americanos no SoFi de Los Angeles com enorme torcida." },
            { cat: "conservadora", mercado: "Turquia finalmente marca", odd: 1.60, resultado: null,
              justificativa: "P(TUR≥1)≈74,1%. TUR acumulou 40+ chutes em 2 jogos sem converter uma vez. Com EUA rodando reservas, os espaços serão maiores. Yildiz (Juventus) e Calhanoglu (Inter) têm qualidade para destravar." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.25, resultado: null,
              justificativa: "λ_total=3,04 — a maior expectativa de gols dos 3 jogos desta rodada. TUR atacará sem pressão eliminatória e EUA-reservas oferecem menos solidez defensiva. P(≥2 gols)≈80,7%." },
            { cat: "intermediaria", mercado: "EUA vence", odd: 2.20, resultado: null,
              justificativa: "pV=45,7% mesmo rodando — maior do que TUR (30,6%). EUA tem profundidade real: Reyna, Brandon Vazquez, Sargent. TUR 0 gols em 2 jogos não inspira confiança ofensiva, mesmo vs reservas." },
            { cat: "intermediaria", mercado: "Kenan Yildiz marca ou dá assistência", odd: 2.80, resultado: null,
              justificativa: "Yildiz, 21 anos (12G+12A pelo Juventus na Serie A 24-25), ainda sem decidir na Copa. Com EUA rodando e déficit defensivo maior, o maior talento individual da Turquia tem espaço para finalmente mostrar seu nível." },
            { cat: "intermediaria", mercado: "Turquia vence", odd: 3.20, resultado: null,
              justificativa: "pM=30,6%. EUA rota para proteger 4 jogadores do segundo amarelo. Com reservas americanos em campo, TUR tem a melhor chance do torneio para sair vitorioso e encerrar a Copa com dignidade." },
            { cat: "loucura", mercado: "Gio Reyna marca", odd: 3.50, resultado: null,
              justificativa: "Reyna (Nottingham Forest) entrou vs PAR e criou perigo. Com Pulisic ainda em dúvida pós-lesão no calf e EUA poupando o time titular, Reyna pode ter sua chance de jogo completo para mostrar valor ao mata-mata." },
            { cat: "loucura", mercado: "Turquia vence + ambas marcam", odd: 4.80, resultado: null,
              justificativa: "Se TUR vence, foi em jogo aberto com EUA-reservas também marcando. P(TUR vence) × P(EUA≥1) ≈ 30,6% × 81,5% ≈ 24,9%. Odd 4,80 acima do valor justo — cenário possível com o elenco B americano em campo." },
            { cat: "loucura", mercado: "Over 3.5 gols", odd: 3.00, resultado: null,
              justificativa: "λ_total=3,04 — o jogo com mais gols esperados desta rodada. TUR com 40+ finalizações represadas e EUA-reservas menos sólidos defensivamente. P(≥4 gols)≈36,3%: valor nas odds 3,00 para o jogo mais aberto." }
          ]
        }
      ]
    }
