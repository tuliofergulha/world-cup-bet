...
const DATA = {
  ...
  dias: [
      ...
      jogos: [
        {
          ...
          local: "Gillette Stadium, Foxborough (Boston)",
          placar: "1 × 4",
          stats: "França goleou e confirmou a liderança do Grupo I. Dembélé fez 3 gols (6', 1T e mais dois na etapa final) e Doué fechou a conta; Aasgaard descontou para a Noruega aos 23'. Maignan defendeu pênalti de Strand Larsen no início do 2T — lance que matou a reação norueguesa. Mbappé não balançou as redes (deu a assistência do 1º gol), Haaland também ficou sem marcar. Noruega avança em 2º e pega Costa do Marfim nos 16-avos.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "França não perde (dupla hipótese)", odd: 1.28, resultado: "hit",
              justificativa: "P(FRA+EMP)=80,7%. França avança com empate e vai jogar compacta. H2H: 7V 4D 4E em 15 jogos. NOR precisa vencer mas não tem como forçar FRA a abrir o jogo. Ryerson lesionado enfraquece o lado direito norueguês. Confirmado: FRA venceu por 4×1." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.50, resultado: "hit",
              justificativa: "λ_total=2,61. NOR vai ao ataque total para 90 min (só a vitória serve). Mbappé e companhia em contra-golpe com espaços. P(≥2 gols)≈78,5% com médias combinadas. Confirmado: 5 gols na partida." },
            { cat: "conservadora", mercado: "França marca", odd: 1.22, resultado: "hit",
              justificativa: "P(FRA≥1)=82,1% com λ_FRA=1,72. Mbappé (4G em 2 jogos) é o melhor jogador em forma do torneio. NOR abre linha para pressionar e cede os espaços que Mbappé explora nas costas da linha. Confirmado: FRA fez 4 gols (Dembélé 3, Doué 1)." },
            { cat: "intermediaria", mercado: "França vence", odd: 1.75, resultado: "hit",
              justificativa: "pV=56,9%. FRA é qualitativamente superior — GD +5 vs +4 mostram eficiência. Oliver (árbitro) é rigoroso; NOR vai pressionar muito e pode abrir espaços. Sem Saliba, o centro de zaga francês com Lacroix resolve. Confirmado: 4×1." },
            { cat: "intermediaria", mercado: "Kylian Mbappé marca", odd: 2.10, resultado: "miss",
              justificativa: "Mbappé com 4G em 2 jogos, mais lucrativo que nunca. Linha norueguesa precisa avançar por obrigação — os espaços nas costas são Mbappé's playground. λ_FRA=1,72, projetando alta participação do capitão. Mbappé deu a assistência do 1º gol mas não balançou as redes." },
            { cat: "intermediaria", mercado: "Erling Haaland marca", odd: 2.40, resultado: "miss",
              justificativa: "Haaland com 4G em 2 jogos (2 vs IRQ, 2 vs SEN). NOR vai ao ataque total — Haaland receberá serviços constantes de Odegaard. Defesa francesa sem Saliba (lesionado); Lacroix é menos sólido na marcação de alto. Haaland ficou sem marcar; quem descontou foi Aasgaard." },
            { cat: "loucura", mercado: "Noruega vence", odd: 4.50, resultado: "miss",
              justificativa: "pM=19,4% — fair odd ~5,15. Motivação máxima: NOR quer ser 1.ª do grupo. Haaland em forma histórica. FRA sem Saliba pode sangrar num jogo aéreo/físico. P≈19% vale a odd com margem de valor. Goleada francesa afastou a zebra." },
            { cat: "loucura", mercado: "Haaland e Mbappé ambos marcam", odd: 5.00, resultado: "miss",
              justificativa: "Os dois artilheiros da Copa em campo. P(Haaland≥1)≈55% × P(Mbappé≥1)≈65% ≈ 36% pela independência. Odd 5,00 oferece valor acima do fair de 2,78 — o confronto narrativo do torneio. Nenhum dos dois marcou; Dembélé roubou a cena." },
            { cat: "loucura", mercado: "Noruega vence + over 2.5 gols", odd: 7.00, resultado: "miss",
              justificativa: "Se NOR vencer, o jogo foi aberto: FRA também marcará em contra e NOR precisará de 2+. P(NOR vence)×P(≥3 gols | NOR vence)≈19%×65%≈12%. Odd 7,00 com margem razoável. Noruega perdeu por 3 gols de diferença." }
          ]
        },
        {
          hora: "16h",
          ...
          local: "BMO Field, Toronto",
          placar: "5 × 0",
          stats: "Goleada histórica: Senegal fez 5 e virou a primeira seleção africana a marcar 5 gols numa Copa. Gols de Diarra (4' 1T), Sarr (10' 2T), Pape Gueye (2x, 13'/25' 2T) e Ndiaye (36' 2T). Rebin Sulaka (IRQ) expulso aos 12' por puxão em Mané que evitava chance clara — jogo com um a mais por 78 minutos. Amarelos para Gueye e Seck (SEN) e Doski (IRQ). Resultado colocou o Senegal na briga pelos melhores terceiros.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Senegal vence", odd: 1.50, resultado: "hit",
              justificativa: "pM=66,4%. SEN tem mais qualidade em todos os setores. IRQ não marcou na Copa (0-3 vs FRA, 1-4 vs NOR — o único gol foi no 4-1 vs NOR). Sem pressão competitiva, SEN pode soltar o jogo. Confirmado: 5×0." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.45, resultado: "hit",
              justificativa: "λ_total=2,58. Sem nada a perder, ambas as equipes vão atacar — especialmente IRQ que quer sair sem vergonha. SEN com Mané e Sarr tende a criar muitas oportunidades. P(≥2 gols)≈77%. Confirmado: 5 gols." },
            { cat: "conservadora", mercado: "Senegal marca no 1T", odd: 1.60, resultado: "hit",
              justificativa: "P(SEN≥1 no 1T)≈60% com λ_SEN=1,90. IRQ vai pressionar mas tem mais lacunas defensivas. Mané e Sarr perigosos desde o início — SEN vai tentar abrir rápido para garantir o resultado. Diarra abriu o placar aos 4'." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 1.85, resultado: "miss",
              justificativa: "P(SEN≥1)≈85%, P(IRQ≥1)≈50%. IRQ marcou 1 gol na Copa (vs NOR), tem capacidade. Sem pressão = defesas menos organizadas. P(ambas marcam)≈43%. IRQ ainda jogou com um a menos após expulsão de Sulaka e não marcou." },
            { cat: "intermediaria", mercado: "Senegal vence por 2+", odd: 2.20, resultado: "hit",
              justificativa: "SEN superior em qualidade. IRQ sem confiança defensiva após tomar 7 gols em 2 jogos. P(SEN vence por ≥2) ≈ 40%+ com a diferença técnica e λ_SEN=1,90 favorecendo goleada parcial. Confirmado: goleada por 5." },
            { cat: "intermediaria", mercado: "Sadio Mané marca", odd: 2.70, resultado: "miss",
              justificativa: "Capitão senegalês com moral para encerrar a Copa com gol. Vs IRQ — a seleção mais permissiva do grupo — Mané tem os espaços que precisa para finalizar. Artilheiro histórico do Senegal. Mané não marcou, mas sofreu a falta que gerou a expulsão de Sulaka." },
            { cat: "loucura", mercado: "Over 3.5 gols", odd: 2.80, resultado: "hit",
              justificativa: "λ_total=2,58 mas sem pressão = jogo aberto. IRQ vai atacar para honrar a Copa; SEN não vai apenas sentar no resultado. P(≥4 gols)≈33% — acima do mercado na maioria das casas. Confirmado: 5 gols na conta." },
            { cat: "loucura", mercado: "Senegal vence a zero", odd: 3.50, resultado: "hit",
              justificativa: "P(SEN vence) × P(IRQ=0) ≈ 66,4% × 50,7% ≈ 33,6%. IRQ marcou 1 gol em 2 jogos. Odd 3,50 próxima ao fair de 2,97 — ligeiro valor. Confirmado: 5×0, clean sheet senegalês." },
            { cat: "loucura", mercado: "Ismaila Sarr marca", odd: 4.50, resultado: "hit",
              justificativa: "Sarr é o outro atacante perigoso do Senegal, com velocidade e capacidade de finalização. IRQ com defesa porosa (7G cedidos). Num jogo sem pressão, Sarr pode ter sua noite. Fair P≈22%. Sarr marcou aos 10' do 2T." }
          ]
        },
        {
          hora: "21h",
          ...
          placar: "0 × 0",
          stats: "Empate sem gols que bastou: Cabo Verde fechou a fase de grupos invicto e carimbou vaga histórica nos 16-avos como 2.º do Grupo H (a vitória da Espanha sobre o Uruguai ajudou). CPV rondou a área saudita mas não converteu; SAU também não levou perigo real. Nasser Al Dawsari (SAU) levou amarelo por falta dura. Arábia Saudita terminou em último no grupo e está eliminada.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Cabo Verde não perde (dupla hipótese)", odd: 1.35, resultado: "hit",
              justificativa: "P(CPV+EMP)=67,5%. CPV precisa só de empate para avançar — vai defender e contra-atacar. SAU desesperada mas com a pior GD do grupo (−4). Estrutura defensiva cpv foi sólida vs ESP e URU. Confirmado: 0×0, CPV avança." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.50, resultado: "miss",
              justificativa: "λ_total=2,99. SAU vai ao ataque total (único caminho). CPV é eficiente no contra-golpe (2-2 vs URU já comprova). P(≥2 gols)≈78,2%. Jogo travado terminou 0×0 — nenhum time converteu." },
            { cat: "conservadora", mercado: "Cabo Verde marca", odd: 1.45, resultado: "miss",
              justificativa: "P(CPV≥1)≈79,8% com λ_CPV=1,62. Varela e Pina já marcaram na Copa. SAU abrindo o jogo para atacar cede espaços nas costas — ideal para os contra-ataques cpv. CPV rondou a área mas não converteu nenhuma chance." },
            { cat: "intermediaria", mercado: "Cabo Verde vence", odd: 2.30, resultado: "miss",
              justificativa: "pM=43,4% — maior que pV(SAU)=32,4%. CPV com confiança histórica após segurar ESP e empatar vs URU. SAU desesperada e com GD −4 complicando qualquer cenário que não seja a vitória. Terminou empatado, sem vencedor." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 1.90, resultado: "miss",
              justificativa: "P(CPV≥1)≈80%, P(SAU≥1)≈74,8%. SAU vai ao ataque; CPV em contra. A dinâmica que CPV já mostrou vs URU (2-2) tende a se repetir. P(ambas marcam)≈59,8%. Nenhuma das duas marcou desta vez." },
            { cat: "intermediaria", mercado: "Hélio Varela marca", odd: 3.00, resultado: "miss",
              justificativa: "Varela marcou o 1.º gol da história de Cabo Verde em Copas. Atua como meia-atacante criativo que pode surgir na segunda linha. SAU abrindo o jogo = mais espaço para Varela surgir e finalizar. Sem gols na partida." },
            { cat: "loucura", mercado: "Cabo Verde vence + SAU marca", odd: 4.50, resultado: "miss",
              justificativa: "CPV pode vencer em jogo aberto onde SAU também marca — como o 2-2 vs URU mostrou. P(CPV vence) × P(SAU≥1) ≈ 43,4% × 74,8% ≈ 32,5%. Odd 4,50 oferece valor sobre o mercado. Empate sem gols invalida o combo." },
            { cat: "loucura", mercado: "Arábia Saudita vence", odd: 3.00, resultado: "miss",
              justificativa: "pV=32,4% — fair odd ~3,09. SAU pode causar a surpresa: motivação máxima (must-win), λ_SAU=1,37 sugere potencial ofensivo. Odd 3,00 praticamente no justo — com margem pequena de valor. SAU não venceu e está eliminada." },
            { cat: "loucura", mercado: "Kevin Pina marca", odd: 5.00, resultado: "miss",
              justificativa: "Pina marcou o gol do empate 2-2 vs URU. Extremo de ritmo com CPV que usa a largura para atacar. SAU vai fazer pressing alto e ceder espaços nas costas para as pontas cpv. Odd 5,00 para um goleador já ativo no torneio. Sem gols no 0×0." }
          ]
        },
        {
          hora: "21h",
          ...
          local: "Estadio Akron, Guadalajara",
          placar: "0 × 1",
          stats: "Espanha venceu magra mas eliminou o bicampeão mundial Uruguai da Copa. Único gol: Álex Baena aos 41' do 1T, aproveitando falha do goleiro Muslera. Jogo mais fechado do que o modelo previa (67% posse ESP, 6 escanteios a 1) — Uruguai sem Araujo e Arrascaeta não conseguiu ameaçar o gol de Espanha, que finalizou pouco (6 chutes, 1 no alvo). Amarelos para Varela e Sanabria (URU) e Baena (ESP). Espanha lidera o Grupo H.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Espanha vence", odd: 1.40, resultado: "hit",
              justificativa: "pV=75,6%. ESP com 4pts, motivada para vencer o grupo. Sem Pedri, Rodri assume controle total do meio. URU sem Araujo e Arrascaeta tem lacuna defensiva e criativa. λ_ESP=2,14 projeta dominância. Confirmado: 1×0." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.35, resultado: "miss",
              justificativa: "λ_total=2,64. ESP com histórico de goleadas (4-0 vs SAU). Yamal e N. Williams perigosíssimos pelas pontas. URU vai ao ataque por necessidade. P(≥2 gols)≈79,7%. Jogo travado, só 1 gol (6 chutes a gol de ESP no total, 1 no alvo)." },
            { cat: "conservadora", mercado: "Espanha marca no 1T", odd: 1.50, resultado: "hit",
              justificativa: "λ_ESP=2,14 — projeção de 1 gol a cada 28 minutos. ESP ativa desde o início com Yamal e Williams. URU sem Araujo na defesa = mais vulnerável a infiltrações pelas pontas espanholas. Baena marcou aos 41' do 1T." },
            { cat: "intermediaria", mercado: "Espanha vence por 2+", odd: 2.10, resultado: "miss",
              justificativa: "P(ESP vence por ≥2) ≈ 44%+. URU sem as principais defesas (Araujo) e criatividade (Arrascaeta). Rodri + Olmo + Yamal podem desmontar a linha uruguaia que já está pressionada. ESP venceu por apenas 1 gol de diferença." },
            { cat: "intermediaria", mercado: "Lamine Yamal marca ou dá assistência", odd: 2.20, resultado: "miss",
              justificativa: "Yamal (18 anos, Barcelona) é o principal criador espanhol com Pedri fora. Joga pela direita com liberdade de cortar e finalizar. URU sem lateral direito habitual de qualidade após baixas — espaço ideal para Yamal. Gol saiu de falha de Muslera, sem envolvimento de Yamal." },
            { cat: "intermediaria", mercado: "Darwin Nuñez marca", odd: 3.20, resultado: "miss",
              justificativa: "Nuñez esperado como titular (Liverpool, 24 anos). URU precisa marcar para ter chance. Darwin é o mais capaz de criar algo do nada com seu poder físico — contra ESP, qualquer chance pode virar gol no contra. Uruguai não marcou (0 gols, 1 escanteio no jogo todo)." },
            { cat: "loucura", mercado: "Nico Williams marca", odd: 4.50, resultado: "miss",
              justificativa: "Williams (Athletic Bilbao, 22 anos) começa a aparecer mais nessa Copa. Como ESP vai atacar, Williams terá mais espaço pelo lado esquerdo. Primeiro gol no torneio pode vir aqui. Não marcou; único gol foi de Baena." },
            { cat: "loucura", mercado: "Federic Valverde marca", odd: 5.50, resultado: "miss",
              justificativa: "Valverde (Real Madrid, 73 caps) é o motor do meio-campo uruguaio. Com URU precisando de gols, Valverde vai chegar mais à frente. Especialista em gols de média distância com finalização potente. Uruguai não conseguiu marcar." },
            { cat: "loucura", mercado: "Espanha −1.5 handicap (vence por 2+) + Yamal/Williams decisivos", odd: 3.50, resultado: "miss",
              justificativa: "ESP vai inflar o placar com a dupla de pontas. λ_ESP=2,14 e URU defensivamente vulnerável. P(ESP vence por 2+)≈44%, com Yamal/Williams como protagonistas. Odd 3,50 oferece valor sobre o mercado. Vitória apertada por 1×0, sem handicap coberto." }
          ]
        },
        {
          hora: "00h",
          ...
          placar: "1 × 1",
          stats: "Empate que garantiu a classificação histórica do Egito (1ª vez nos 16-avos) na vice-liderança do Grupo G. Mahmoud Saber abriu o placar aos 5' aproveitando rebote de cruzamento de Salah espalmado por Beiranvand — gol mais rápido da história egípcia em Copas. Rezaeian empatou para o Irã aos 14'. Salah criou a jogada do gol mas não balançou as redes ele mesmo (68 gols segue o recorde). Irã teve gol anulado no fim e terminou em 3º do grupo, fora do mata-mata. Irã foi a equipe mais faltosa (16 faltas, 4 amarelos) contra 11 faltas e 3 amarelos do Egito; escanteios 8 a 2 para o Egito.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Egito não perde (dupla hipótese)", odd: 1.55, resultado: "hit",
              justificativa: "P(EGI+EMP)=60,5%. EGI avança com empate — vai defender e jogar no contra. IRÃ precisa atacar, abre espaço. Salah no contra-golpe é uma ameaça constante mesmo em formação defensiva. Confirmado: empate garantiu a vaga." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.55, resultado: "hit",
              justificativa: "λ_total=2,83. IRÃ vai ao ataque total (precisa vencer). EGI em contra-golpe eficiente (3-1 vs NZL). P(≥2 gols)≈77,4%. Confirmado: 1×1, 2 gols." },
            { cat: "conservadora", mercado: "Mohamed Salah marca", odd: 2.00, resultado: "miss",
              justificativa: "Salah participou (G ou A) em todos os 4 jogos de Copa na carreira. Com 68 gols para EGI, um gol aqui = recorde histórico. IRÃ vai pressionar alto, abrindo espaço para os contra-golpes de Salah. Salah criou o gol (cruzamento espalmado) mas quem marcou foi Mahmoud Saber." },
            { cat: "intermediaria", mercado: "Irã vence", odd: 2.55, resultado: "miss",
              justificativa: "pV=39,5% — Elo sugere que IRÃ é levemente superior (maior que pM=35,4%!). Must-win = motivação máxima. λ_IRÃ=1,46 > λ_EGI=1,37. IRÃ tem capacidade para vencer. Empatou e ainda teve gol anulado no fim — ficou fora do mata-mata." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 1.90, resultado: "hit",
              justificativa: "P(EGI≥1)≈74,6%, P(IRÃ≥1)≈76,9%. IRÃ atacará por 90 min; EGI em contra. Jogo aberto garantido com λ_total=2,83. P(ambas marcam)≈57,3%. Confirmado: Saber e Rezaeian marcaram." },
            { cat: "intermediaria", mercado: "Egito vence", odd: 2.90, resultado: "miss",
              justificativa: "pM=35,4%. Se EGI marca cedo, IRÃ vai ao tudo-ou-nada e cede ainda mais espaço — Salah e companhia em contra-golpe. Vitória egípcia possível mesmo não sendo o favorito do modelo. Egito só empatou, mas o ponto já bastava." },
            { cat: "loucura", mercado: "Salah bissa", odd: 6.50, resultado: "miss",
              justificativa: "Salah em modo record-chasing. Com IRÃ forçado a pressionar e EGI em contra, as oportunidades para Salah finalizar se multiplicam. P(Salah marca 2+) ≈ 15% com λ_EGI=1,37 concentrado no capitão. Salah não marcou nenhum gol na partida." },
            { cat: "loucura", mercado: "Irã vence + ambas marcam", odd: 4.50, resultado: "miss",
              justificativa: "P(IRÃ vence) × P(EGI≥1) ≈ 39,5% × 74,6% ≈ 29,5%. Se IRÃ vencer, provavelmente em jogo aberto com EGI também marcando. Odd 4,50 supera o fair de 3,39 — valor claro. Irã não venceu, ficou no empate." },
            { cat: "loucura", mercado: "Over 3.5 gols", odd: 3.00, resultado: "miss",
              justificativa: "λ_total=2,83. P(≥4 gols)≈38,2%. IRÃ pressionando para o must-win e EGI em contra-golpe = jogo com troca de golpes. Odd 3,00 com valor para o apostador que acredita no drama de Seattle. Só 2 gols na partida." }
          ]
        },
        {
          hora: "00h",
          ...
          local: "BC Place, Vancouver",
          placar: "1 × 5",
          stats: "Bélgica finalmente engrenou e goleou para fechar a fase de grupos na liderança. Trossard (27' 1T e 4' 2T), De Bruyne (20' 2T), Lukaku (40' 2T) e Saelemaekers (48' 2T) marcaram; Just descontou para a Nova Zelândia (38' 2T) após rebote de Courtois. De Bruyne, aos 34 anos, decisivo mais uma vez (1 gol) antes de sair aos 72'. Nova Zelândia eliminada com 1 ponto.",
          numeros: [
          ...
          dicas: [
            { cat: "conservadora", mercado: "Bélgica vence a zero", odd: 1.85, resultado: "miss",
              justificativa: "P(BEL vence) × P(NZL=0) ≈ 82,3% × 68,4% ≈ 56,3%. λ_NZL=0,38 — a menor expectativa ofensiva de todos os jogos de hoje. NZL marcou apenas 2 gols no torneio (vs IRÃ). Odd 1,85 com valor sobre o fair ~1,78. NZL descontou com Just aos 38' do 2T." },
            { cat: "conservadora", mercado: "Bélgica marca no 1T", odd: 1.45, resultado: "hit",
              justificativa: "P(BEL≥1 no 1T)≈70%. BEL precisa de vitória clara para convencer o critério de 3.º — vai ao ataque desde o início. λ_BEL=2,39 é a maior expectativa de todos os jogos desta rodada. Trossard abriu o placar aos 27' do 1T." },
            { cat: "conservadora", mercado: "Over 2.5 gols", odd: 1.70, resultado: "hit",
              justificativa: "λ_total=2,77. BEL pressionada pelo must-win vai atacar em cheio; NZL não consegue fechar o espaço por 90 min. P(≥3 gols)≈53,3%. Confirmado: 6 gols na partida." },
            { cat: "intermediaria", mercado: "Bélgica −1.5 handicap (vence por 2+)", odd: 1.90, resultado: "hit",
              justificativa: "P(BEL vence por ≥2) ≈ 55%+. NZL perdeu 1-3 vs EGI — e EGI tem λ=2,08 vs λ_BEL=2,39. BEL maior e mais técnica. De Bruyne + eventual Lukaku/CDK = ataque pluriponteiro. Confirmado: goleada por 4 gols de diferença." },
            { cat: "intermediaria", mercado: "Kevin De Bruyne marca ou dá assistência", odd: 2.00, resultado: "hit",
              justificativa: "De Bruyne (34 anos) pode estar jogando sua última Copa. 37G em 119 caps para a Bélgica. Vs NZL — a mais permeável — é a chance de brilhar que a campanha não ofereceu ainda. De Bruyne marcou aos 20' do 2T antes de sair aos 72'." },
            { cat: "intermediaria", mercado: "Over 3.5 gols", odd: 2.80, resultado: "hit",
              justificativa: "BEL reprimida após 2 empates vai explodir. λ_BEL=2,39 + P(NZL≥1)≈32%. P(≥4 gols)≈40,5% — valor nas odds. Confirmado: 6 gols no total." },
            { cat: "loucura", mercado: "Bélgica vence + over 3.5 gols", odd: 3.50, resultado: "hit",
              justificativa: "P(BEL vence) × P(≥4 gols | BEL vence) ≈ 82% × 45% ≈ 37%. BEL com frustração acumulada de 2 empates vai ao ataque máximo vs a pior equipe do grupo. Odd 3,50 com valor. Confirmado: 5×1." },
            { cat: "loucura", mercado: "Charles De Ketelaere marca", odd: 5.50, resultado: "miss",
              justificativa: "CDK (Atalanta) pode começar no lugar de Lukaku. Técnico, movimenta-se melhor em espaço curto. NZL com linha baixa dá espaço entre as linhas para CDK surgir e finalizar. Estreia de goleador tardio. Quem marcou no lugar foi Lukaku, de cabeça, aos 40' do 2T." },
            { cat: "loucura", mercado: "Bélgica marca 4+", odd: 5.00, resultado: "hit",
              justificativa: "P(BEL≥4) ≈ 22% com λ_BEL=2,39. BEL vai ao ataque sem freio; NZL perdeu 1-3 vs EGI que tem λ=2,08 < λ_BEL=2,39. Goleada belga é o cenário ideal para a classificação — e a equipe vai tentar forçá-la. Confirmado: Bélgica fez 5 gols." }
          ]
        }
      ]
    },
    {
      data: "2026-06-27",
      titulo: "Dia 17 — Fecha a fase de grupos: Messi decide, Argélia e Áustria fazem 3×3 dramático",
      contexto: "Última rodada dos Grupos J, K e L encerra a fase de grupos completa da Copa. Grupo J: Argentina (já classificada) folgada contra Jordânia (eliminada); Argélia e Áustria brigavam por vaga direta e pelos melhores terceiros, com Irã torcendo por um resultado que não veio. Grupo K: Colômbia e Portugal jogavam por 1º lugar; RD Congo x Uzbequistão decidia quem seguia entre os melhores terceiros. Grupo L: Inglaterra buscava a liderança contra o já eliminado Panamá; Croácia x Gana valia 2ª posição.",
      jogos: [
        {
          hora: "16h",
          mandante: "Argélia",
          ...
          placar: "3 × 3",
          stats: "Jogo eletrizante com direito a virada nos acréscimos. Arnautovic abriu (28'), Belghali igualou para a Argélia antes do intervalo, Sabitzer recolocou a Áustria na frente (55'), Mahrez virou para a Argélia com dois gols (60' e 90+3'), e Kalajdzic decretou o 3×3 nos acréscimos finais (90+6'). O resultado classificou as DUAS seleções — Áustria em 2º do grupo e Argélia como um dos melhores terceiros, eliminando o Irã dessa disputa.",
          numeros: [
            { v: "3×3", l: "Placar final — 6 gols e 2 gols nos acréscimos" },
            { v: "2", l: "Gols de Riyad Mahrez na partida (60' e 90+3')" },
            { v: "1982", l: "Última vez que a Áustria avançou de uma fase de grupos antes desta Copa" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Over 2.5 gols", odd: 1.65, resultado: "hit",
              justificativa: "Confronto direto valendo vaga, ambas precisavam atacar. Áustria com Arnautovic/Sabitzer em boa fase ofensiva, Argélia com Mahrez decisivo. Terminou 3×3 — 6 gols na conta." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.55, resultado: "hit",
              justificativa: "Duas equipes precisando de resultado tendem a se abrir. Confirmado com folga: 3 gols para cada lado." },
            { cat: "conservadora", mercado: "Riyad Mahrez marca", odd: 2.30, resultado: "hit",
              justificativa: "Mahrez como principal referência ofensiva argelina nesta Copa. Marcou os dois gols que buscaram a virada para a Argélia." },
            { cat: "intermediaria", mercado: "Argélia vence", odd: 2.60, resultado: "miss",
              justificativa: "Argélia parecia to caminho da virada com os gols de Mahrez, mas sofreu o empate nos acréscimos com Kalajdzic — ficou no 3×3." },
            { cat: "intermediaria", mercado: "Marko Arnautovic marca", odd: 3.00, resultado: "hit",
              justificativa: "Arnautovic como principal centroavante austríaco. Abriu o placar aos 28' e recebeu o único cartão amarelo do jogo." },
            { cat: "intermediaria", mercado: "Jogo tem gol nos acréscimos", odd: 3.50, resultado: "hit",
              justificativa: "Jogo decisivo tende a ter desespero final. Dois gols saíram dos acréscimos (Mahrez aos 90+3' e Kalajdzic aos 90+6') — dramaticidade típica de rodada decisiva." },
            { cat: "loucura", mercado: "Over 4.5 gols", odd: 4.50, resultado: "hit",
              justificativa: "Confronto aberto com muito em jogo para ambos os lados. 6 gols na conta final supera a marca com folga." },
            { cat: "loucura", mercado: "Sasa Kalajdzic marca", odd: 5.50, resultado: "hit",
              justificativa: "Reserva de luxo austríaco entrando no 2º tempo. Decidiu o 3×3 de cabeça nos acréscimos finais, um clássico gol de quem entra fresco no fim." },
            { cat: "loucura", mercado: "Empate + ambas marcam 3", odd: 8.00, resultado: "hit",
              justificativa: "Cenário de loucura total que se confirmou: 3×3 com gols em sequência até os acréscimos — resultado raro que classificou as duas seleções." }
          ]
        },
        {
          hora: "16h",
          ...
          placar: "1 × 3",
          stats: "Argentina, já classificada, administrou mas venceu com autoridade. Lo Celso (19') e Lautaro Martínez (31') fizeram no 1º tempo; Al-Taamari descontou para a Jordânia (50'); Messi, que saiu do banco, fechou a conta aos 80'. Amarelos para Abu Taha e Al-Arab (Jordânia). Argentina termina invicta e 100% na fase de grupos.",
          numeros: [
            { v: "3×1", l: "Placar final — Argentina 100% na fase de grupos" },
            { v: "80'", l: "Minuto do gol de Messi, que saiu do banco" },
            { v: "2", l: "Gols argentinos no 1º tempo (Lo Celso e Lautaro)" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Argentina vence", odd: 1.30, resultado: "hit",
              justificativa: "Campeã mundial defendendo o título, muito acima do nível da estreante Jordânia. Vitória tranquila por 3×1." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.35, resultado: "hit",
              justificativa: "Ataque argentino em boa fase (Lautaro, Lo Celso, Messi no banco). 4 gols na partida." },
            { cat: "conservadora", mercado: "Argentina marca no 1T", odd: 1.45, resultado: "hit",
              justificativa: "Lo Celso e Lautaro Martínez já haviam resolvido antes do intervalo, aos 19' e 31'." },
            { cat: "intermediaria", mercado: "Lionel Messi marca", odd: 2.60, resultado: "hit",
              justificativa: "Mesmo saindo do banco, Messi é decisivo sempre que entra. Fechou a conta aos 80', mantendo a artilharia em alta mesmo com minutagem reduzida na fase de grupos." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 2.10, resultado: "hit",
              justificativa: "Jordânia sem nada a perder tende a se lançar ao ataque. Al-Taamari descontou aos 50' do 2T." },
            { cat: "intermediaria", mercado: "Lautaro Martínez marca", odd: 2.30, resultado: "hit",
              justificativa: "Lautaro como titular absoluto do ataque albiceleste. Marcou aos 31' do 1T, seu gol de rotina nesta Copa." },
            { cat: "loucura", mercado: "Messi entra e decide (marca)", odd: 4.00, resultado: "hit",
              justificativa: "Narrativa do capitão argentino sendo poupado e decidindo quando entra — se confirmou com o gol aos 80'." },
            { cat: "loucura", mercado: "Giovani Lo Celso marca", odd: 5.00, resultado: "hit",
              justificativa: "Lo Celso como opção criativa que também ataca a área. Abriu o placar aos 19' do 1T." },
            { cat: "loucura", mercado: "Over 3.5 gols", odd: 4.00, resultado: "hit",
              justificativa: "Ataque argentino pluriofensivo contra defesa jordaniana estreante e frágil. 4 gols confirmaram o total." }
          ]
        },
        {
          hora: "20h",
          ...
          placar: "0 × 0",
          stats: "Jogo movimentado sem gols — ambas tiveram chances claras mas desperdiçaram. Gol anulado de Davinson Sánchez no fim por impedimento milimétrico no VAR; João Félix e Cristiano Ronaldo também tiveram chances desperdiçadas ou anuladas. Empate garantiu a Colômbia o 1º lugar do Grupo K e a Portugal o 2º.",
          numeros: [
            { v: "0×0", l: "Placar final — decidido no detalhe do VAR" },
            { v: "1º", l: "Posição final da Colômbia no Grupo K" },
            { v: "2º", l: "Posição final de Portugal, que pega a Croácia nos 16-avos" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Colômbia não perde (dupla hipótese)", odd: 1.40, resultado: "hit",
              justificativa: "Colômbia só precisava de um ponto para o 1º lugar. Segurou o 0×0 mesmo com pressão portuguesa no fim." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.95, resultado: "miss",
              justificativa: "Duas seleções ofensivas com Luis Díaz e Cristiano Ronaldo. Apesar das chances criadas (gol anulado de cada lado), nenhuma converteu — 0×0." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.55, resultado: "miss",
              justificativa: "Ambas atacaram bastante segundo os relatos (grandes chances desperdiçadas), mas o jogo terminou sem gols válidos." },
            { cat: "intermediaria", mercado: "Cristiano Ronaldo marca", odd: 2.80, resultado: "miss",
              justificativa: "CR7 teve chances mas desperdiçou ou foi anulado por impedimento — não converteu no 0×0." },
            { cat: "intermediaria", mercado: "Portugal vence", odd: 2.60, resultado: "miss",
              justificativa: "Portugal precisava vencer para tentar o 1º lugar; não conseguiu, ficou no empate sem gols e avançou em 2º." },
            { cat: "intermediaria", mercado: "Luis Díaz marca", odd: 2.90, resultado: "miss",
              justificativa: "Díaz vinha em grande fase na Copa (decisivo vs Uzbequistão). Não conseguiu balançar as redes desta vez." },
            { cat: "loucura", mercado: "Jogo tem gol anulado pelo VAR", odd: 3.50, resultado: "hit",
              justificativa: "Jogo tenso e decisivo tende a ter intervenções de VAR no fim. Confirmado: gol de Davinson Sánchez anulado por impedimento no dedão do pé." },
            { cat: "loucura", mercado: "Colômbia vence a zero", odd: 4.00, resultado: "miss",
              justificativa: "Colômbia buscando o 1º lugar com autoridade. Terminou empatada, não venceu." },
            { cat: "loucura", mercado: "Under 0.5 gols (sem gols no jogo)", odd: 3.20, resultado: "hit",
              justificativa: "Jogo truncado e decisivo, com equipes cautelosas mesmo tendo chances. Confirmado 0×0 apesar do volume ofensivo." }
          ]
        },
        {
          hora: "20h",
          ...
          placar: "3 × 1",
          stats: "RD Congo precisava vencer para seguir viva na disputa dos melhores terceiros e conseguiu — Wissa (2 gols) e Mayele marcaram; Shomurodov descontou para o Uzbequistão, eliminado sem pontos na estreia em Copas. Amarelos para Mbuku, Motoussamy e Sadiki (RD Congo) e Khusanov e Nasrullaev (UZB). Congo garantiu vaga histórica nos 16-avos como um dos melhores terceiros.",
          numeros: [
            { v: "3×1", l: "Placar final — Congo garante vaga nos melhores terceiros" },
            { v: "2", l: "Gols de Yoane Wissa na partida" },
            { v: "0pts", l: "Uzbequistão termina a estreia em Copas sem pontuar" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "RD Congo vence", odd: 2.00, resultado: "hit",
              justificativa: "Congo precisava da vitória a qualquer custo para seguir vivo na disputa dos terceiros. Confirmado: 3×1." },
            { cat: "conservadora", mercado: "Over 2.5 gols", odd: 1.80, resultado: "hit",
              justificativa: "Jogo decisivo para o Congo, que precisava atacar bastante. 4 gols na partida confirmam o over." },
            { cat: "conservadora", mercado: "Yoane Wissa marca", odd: 2.20, resultado: "hit",
              justificativa: "Wissa como principal referência ofensiva congolesa nesta Copa (já havia marcado contra Portugal). Fez 2 gols desta vez." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 1.90, resultado: "hit",
              justificativa: "Uzbequistão eliminado mas competitivo. Shomurodov descontou, confirmando o mercado." },
            { cat: "intermediaria", mercado: "RD Congo vence por 2+", odd: 2.40, resultado: "hit",
              justificativa: "Necessidade máxima de gols para o Congo tentar entrar entre os terceiros. Venceu por 2 gols de diferença (3×1)." },
            { cat: "intermediaria", mercado: "Wissa marca 2+", odd: 4.50, resultado: "hit",
              justificativa: "Wissa em grande fase de artilharia na Copa. Balançou as redes duas vezes no jogo decisivo." },
            { cat: "loucura", mercado: "Over 3.5 gols", odd: 3.20, resultado: "hit",
              justificativa: "Jogo aberto entre time precisando de gols (Congo) e eliminado jogando sem pressão (Uzb). 4 gols confirmam o total." },
            { cat: "loucura", mercado: "Eldior Shomurodov marca", odd: 5.00, resultado: "hit",
              justificativa: "Shomurodov como principal opção ofensiva do Uzbequistão. Descontou mesmo com a eliminação consumada." },
            { cat: "loucura", mercado: "RD Congo vence + Wissa decisivo (2+ gols)", odd: 6.00, resultado: "hit",
              justificativa: "Combo que se apoia na centralidade de Wissa no ataque congolês em jogo do tudo ou nada. Confirmado: vitória por 3×1 com Wissa balançando as redes duas vezes." }
          ]
        },
        {
          hora: "20h",
          ...
          placar: "2 × 0",
          stats: "Inglaterra fechou com autoridade e liderança do Grupo L. Bellingham e Kane (histórico) marcaram no 2º tempo contra o já eliminado Panamá, que ainda complicou bastante no 1º tempo. Amarelos para Fajardo e Andrade (Panamá) e Quansah (Inglaterra).",
          numeros: [
            { v: "2×0", l: "Placar final — Inglaterra 1ª do Grupo L com 7 pontos" },
            { v: "2", l: "Vitórias + 1 empate — campanha inglesa na fase de grupos" },
            { v: "0pts", l: "Panamá eliminado sem pontuar no grupo" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Inglaterra vence", odd: 1.35, resultado: "hit",
              justificativa: "Favorita clara contra o já eliminado Panamá, que só teria orgulho a jogar. Vitória por 2×0." },
            { cat: "conservadora", mercado: "Inglaterra vence a zero", odd: 1.75, resultado: "hit",
              justificativa: "Defesa inglesa sólida na campanha, Panamá sem poder de fogo suficiente. Confirmado clean sheet." },
            { cat: "conservadora", mercado: "Harry Kane marca", odd: 1.90, resultado: "hit",
              justificativa: "Kane como artilheiro histórico inglês, decisivo mais uma vez no 2º tempo." },
            { cat: "intermediaria", mercado: "Jude Bellingham marca", odd: 2.50, resultado: "hit",
              justificativa: "Bellingham como principal criador/finalizador do meio-campo inglês. Abriu o placar no 2º tempo." },
            { cat: "intermediaria", mercado: "Under 2.5 gols", odd: 1.85, resultado: "hit",
              justificativa: "Panamá eliminado tende a se fechar; Inglaterra sem necessidade de golear. Terminou em 2×0, dentro do under." },
            { cat: "intermediaria", mercado: "Inglaterra marca no 2T", odd: 1.60, resultado: "hit",
              justificativa: "Panamá segurou bem o 1º tempo segundo os relatos, mas a Inglaterra usou a qualidade individual para decidir na etapa final — Bellingham e Kane, ambos no 2T." },
            { cat: "loucura", mercado: "Bellingham e Kane ambos marcam", odd: 4.00, resultado: "hit",
              justificativa: "Dupla mais decisiva da Inglaterra nesta Copa. Ambos balançaram as redes no 2º tempo." },
            { cat: "loucura", mercado: "Panamá não finaliza no alvo", odd: 3.80, resultado: "miss",
              justificativa: "Panamá eliminado e sem qualidade ofensiva refinada — mas relatos indicam que o time complicou bastante e criou algumas chances, mesmo sem conseguir marcar." },
            { cat: "loucura", mercado: "Inglaterra vence a zero + Kane marca", odd: 3.20, resultado: "hit",
              justificativa: "Combo natural para o favorito absoluto do confronto. Confirmado: 2×0 com gol de Kane." }
          ]
        },
        {
          hora: "20h",
          ...
          placar: "2 × 1",
          stats: "Croácia venceu e garantiu o 2º lugar do Grupo L. Sucic abriu o placar (31' 1T); Lookman igualou em lance revisado longamente pelo VAR (28' 2T); Vlasic devolveu a vantagem croata na sequência. Ambas as seleções avançam — Croácia em 2º, Gana como um dos melhores terceiros.",
          numeros: [
            { v: "2×1", l: "Placar final — ambas avançam ao mata-mata" },
            { v: "2º", l: "Posição final da Croácia no Grupo L" },
            { v: "melhores 3os", l: "Gana garante vaga via terceiros colocados" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Croácia não perde (dupla hipótese)", odd: 1.45, resultado: "hit",
              justificativa: "Croácia com elenco experiente buscando o 2º lugar do grupo. Venceu por 2×1." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.80, resultado: "hit",
              justificativa: "Gana precisando de resultado positivo para embalar a briga pelos terceiros, tende a se lançar ao ataque. Confirmado: Lookman marcou pela seleção africana." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.60, resultado: "hit",
              justificativa: "Jogo direto valendo posição no grupo. 3 gols confirmam o total." },
            { cat: "intermediaria", mercado: "Croácia vence", odd: 2.10, resultado: "hit",
              justificativa: "Croácia mais experiente e organizada, mesmo passando por transição geracional. Venceu por 2×1." },
            { cat: "intermediaria", mercado: "Luka Sucic marca", odd: 3.00, resultado: "hit",
              justificativa: "Sucic surgindo como opção ofensiva croata nesta Copa. Abriu o placar aos 31' do 1T." },
            { cat: "intermediaria", mercado: "Ademola Lookman marca", odd: 2.80, resultado: "hit",
              justificativa: "Lookman como principal nome ofensivo do Gana. Marcou em lance revisado pelo VAR." },
            { cat: "loucura", mercado: "Jogo tem revisão longa do VAR", odd: 3.00, resultado: "hit",
              justificativa: "Jogo decisivo tende a gerar contestação e revisões demoradas. Confirmado: gol de Lookman só foi validado após longa análise do VAR." },
            { cat: "loucura", mercado: "Nikola Vlasic marca", odd: 4.50, resultado: "hit",
              justificativa: "Vlasic como opção do meio-campo croata que também ataca a área. Devolveu a vantagem croata na sequência do empate de Lookman." },
            { cat: "loucura", mercado: "Croácia vence + Gana marca", odd: 3.80, resultado: "hit",
              justificativa: "Combo que reflete um jogo aberto onde a Croácia vence mas o Gana, precisando de gols, também balança as redes. Confirmado: 2×1." }
          ]
        }
      ]
    },
    {
      data: "2026-06-28",
      titulo: "Dia 18 — Abre o mata-mata: Canadá estreia nos 16-avos com gol nos acréscimos",
      contexto: "Primeiro jogo da fase eliminatória de 32 (16-avos), formato inédito criado pela expansão para 48 seleções. País-sede Canadá estreia como mandante direto contra a África do Sul, terceira colocada do grupo D.",
      jogos: [
        {
          hora: "16h",
          ...
          local: "SoFi Stadium, Los Angeles",
          placar: "0 × 1",
          stats: "Canadá avançou com gol nos acréscimos: Stephen Eustáquio recebeu cruzamento da direita após saída errada da defesa sul-africana e bateu de primeira no ângulo, aos 46' do 2T. África do Sul teve mais posse (55% a 45%) mas não converteu as chances criadas. Amarelos para Saliba e Sigur, ambos do Canadá — Sigur viu dois cartões (53' e 66') sem ser expulso por acúmulo nesta partida. Árbitro: João Pinheiro (POR). Canadá enfrenta Marrocos nas oitavas.",
          numeros: [
            { v: "0×1", l: "Placar final — gol nos acréscimos do 2T" },
            { v: "46'", l: "Minuto do gol de Eustáquio (2T)" },
            { v: "55%", l: "Posse de bola da África do Sul, que não converteu o volume de jogo" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Canadá não perde (dupla hipótese)", odd: 1.30, resultado: "hit",
              justificativa: "Canadá como mandante-sede em melhor momento de forma na campanha de grupos. Venceu por 1×0 mesmo sofrendo pressão." },
            { cat: "conservadora", mercado: "Under 2.5 gols", odd: 1.55, resultado: "hit",
              justificativa: "Jogo de mata-mata tende a ser mais cauteloso. Terminou com apenas 1 gol." },
            { cat: "conservadora", mercado: "Canadá marca", odd: 1.60, resultado: "hit",
              justificativa: "Canadá com ataque mais articulado na campanha de grupos. Eustáquio confirmou aos 46' do 2T." },
            { cat: "intermediaria", mercado: "Canadá vence", odd: 2.10, resultado: "hit",
              justificativa: "Apesar da pressão sul-africana (55% de posse), o Canadá teve a melhor chance e converteu, fechando com vitória." },
            { cat: "intermediaria", mercado: "Jogo tem gol nos acréscimos", odd: 3.00, resultado: "hit",
              justificativa: "Jogo equilibrado e nervoso de mata-mata tende a se decidir no fim. Confirmado: gol aos 46' do 2T." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 2.20, resultado: "miss",
              justificativa: "África do Sul com bom volume ofensivo (55% de posse) poderia ter furado a defesa canadense — mas não converteu nenhuma chance real." },
            { cat: "loucura", mercado: "Stephen Eustáquio marca", odd: 6.00, resultado: "hit",
              justificativa: "Meio-campista canadense com participação ofensiva relevante na campanha. Decidiu com um golaço de primeira no ângulo." },
            { cat: "loucura", mercado: "Canadá vence a zero", odd: 2.60, resultado: "hit",
              justificativa: "Defesa canadense seguindo sólida mesmo sob pressão. Confirmado clean sheet em 1×0." },
            { cat: "loucura", mercado: "Under 1.5 gols", odd: 2.00, resultado: "hit",
              justificativa: "Jogo de mata-mata inaugural tende a ser truncado. Apenas 1 gol na partida confirma o total baixo." }
          ]
        }
      ]
    },
    {
      data: "2026-06-29",
      titulo: "Dia 19 — Brasil sofre mas vira, Alemanha e Holanda caem nos pênaltis",
      contexto: "Segundo dia dos 16-avos com três jogos de peso. Brasil enfrenta o Japão em Houston buscando embalar rumo ao hexa; Alemanha e Paraguai se enfrentam em Boston; Holanda encara o Marrocos em Monterrey à noite. Duas zebras: Paraguai elimina a Alemanha e Marrocos elimina a Holanda, ambas nos pênaltis.",
      jogos: [
        {
          hora: "14h",
          mandante: "Brasil",
          ...
          local: "NRG Stadium, Houston",
          placar: "2 × 1",
          stats: "Brasil sofreu, tomou gol do Japão ainda no 1T com Kaishu Sano (29'), mas virou na etapa final: Casemiro empatou aos 11' do 2T e Martinelli decidiu nos acréscimos (45+5'). Árbitro italiano Maurizio Mariani deu 5 amarelos: Casemiro e Danilo (BRA), Sano, Kamada e Suzuki (JPN). Brasil avança às oitavas.",
          numeros: [
            { v: "2×1", l: "Placar final — Brasil vira no 2º tempo" },
            { v: "45+5'", l: "Minuto do gol decisivo de Martinelli" },
            { v: "5", l: "Cartões amarelos distribuídos pelo árbitro Mariani" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Brasil vence", odd: 1.50, resultado: "hit",
              justificativa: "Brasil favorito claro mesmo sofrendo pressão japonesa. Virou o jogo para vencer por 2×1." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.55, resultado: "hit",
              justificativa: "Ambas as seleções ofensivas na campanha de grupos. 3 gols confirmaram o total." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.75, resultado: "hit",
              justificativa: "Japão organizado taticamente sempre cria alguma chance. Sano confirmou aos 29' do 1T." },
            { cat: "intermediaria", mercado: "Brasil vence de virada", odd: 3.50, resultado: "hit",
              justificativa: "Japão tecnicamente competente pode abrir o placar, mas o elenco brasileiro tem individualidades para reverter. Confirmado: Casemiro e Martinelli viraram no 2T." },
            { cat: "intermediaria", mercado: "Casemiro marca", odd: 4.50, resultado: "hit",
              justificativa: "Casemiro raramente ataque, mas em jogo decisivo pode aparecer na área. Empatou aos 11' do 2T." },
            { cat: "intermediaria", mercado: "Gabriel Martinelli marca", odd: 3.20, resultado: "hit",
              justificativa: "Martinelli ganhando espaço no ataque brasileiro pela ponta. Decidiu nos acréscimos finais." },
            { cat: "loucura", mercado: "Jogo tem gol nos acréscimos", odd: 2.80, resultado: "hit",
              justificativa: "Jogo equilibrado tende a se decidir no fim. Martinelli confirmou aos 45+5' do 2T." },
            { cat: "loucura", mercado: "Kaishu Sano marca", odd: 5.00, resultado: "hit",
              justificativa: "Japão com ataque organizado e capaz de surpreender times grandes. Sano abriu o placar aos 29' do 1T." },
            { cat: "loucura", mercado: "Brasil vence + Casemiro e Martinelli decisivos", odd: 8.00, resultado: "hit",
              justificativa: "Combo apoiado na dupla que reverteu o placar — cenário que se confirmou integralmente." }
          ]
        },
        {
          hora: "17h30",
          ...
          placar: "1 × 1",
          stats: "Paraguai fez a zebra do dia: empatou em 1×1 no tempo normal (Enciso 41' 1T x Havertz 9' 2T, sem gols na prorrogação) e venceu por 4×3 nos pênaltis. Goleiro Orlando Gill defendeu duas cobranças alemãs (Sanabria e Balbuena converteram para o PAR; Kimmich, Musiala e Amiri também converteram para a ALE, mas Havertz, Woltemade e Tah desperdiçaram). Amarelos: Cubas, Almirón e Galarza (PAR); Havertz, Musiala e o técnico Nagelsmann (ALE). Alemanha eliminada nos 16-avos.",
          numeros: [
            { v: "1×1", l: "Placar no tempo normal/prorrogação" },
            { v: "4×3", l: "Disputa de pênaltis — vitória paraguaia" },
            { v: "2", l: "Pênaltis defendidos pelo goleiro Orlando Gill" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Under 2.5 gols", odd: 1.60, resultado: "hit",
              justificativa: "Jogo de mata-mata entre seleções organizadas tende a ser mais fechado. Terminou 1×1 no tempo normal." },
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.90, resultado: "hit",
              justificativa: "Paraguai com Enciso e Almirón perigosos, Alemanha com Havertz centralizando o ataque. Ambas confirmaram gol." },
            { cat: "conservadora", mercado: "Alemanha vence", odd: 1.55, resultado: "miss",
              justificativa: "Alemanha favorita pelo histórico e elenco mais qualificado. Não venceu — ficou no empate e caiu nos pênaltis." },
            { cat: "intermediaria", mercado: "Jogo vai a pênaltis", odd: 4.50, resultado: "hit",
              justificativa: "Duas seleções equilibradas no confronto direto de mata-mata. Empate em 1×1 levou à disputa de pênaltis." },
            { cat: "intermediaria", mercado: "Kai Havertz marca", odd: 2.60, resultado: "hit",
              justificativa: "Havertz como principal referência ofensiva alemã. Empatou aos 9' do 2T, mas depois desperdiçou pênalti decisivo." },
            { cat: "intermediaria", mercado: "Paraguai avança (elimina Alemanha)", odd: 6.00, resultado: "hit",
              justificativa: "Zebra plausível dado o histórico de Copas do Mundo com surpresas nos 16/oitavas. Confirmada: Paraguai venceu nos pênaltis." },
            { cat: "loucura", mercado: "Julio Enciso marca", odd: 5.00, resultado: "hit",
              justificativa: "Enciso como principal criador paraguaio. Abriu o placar aos 41' do 1T." },
            { cat: "loucura", mercado: "Jogo termina empatado no tempo normal + Paraguai vence nos pênaltis", odd: 9.00, resultado: "hit",
              justificativa: "Combo de zebra completa — empate seguido de classificação paraguaia via pênaltis. Confirmado integralmente." },
            { cat: "loucura", mercado: "Alemanha perde na disputa de pênaltis", odd: 4.00, resultado: "hit",
              justificativa: "Alemanha historicamente inconsistente em disputas de pênaltis recentes. Havertz, Woltemade e Tah desperdiçaram, e o time caiu por 4×3." }
          ]
        },
        {
          hora: "22h",
          ...
          visitante: "Marrocos",
          fase: "16-avos de final",
          local: "Estadio BBVA, Monterrey",
          placar: "1 × 1",
          stats: "Marrocos repetiu a zebra do dia e eliminou a Holanda nos pênaltis (3×2) após 1×1 no tempo normal (Gakpo x Diop). Sequência dramática: El Aynaoui e Kluivert desperdiçaram na trave, Rahimi e Weghorst converteram, Timber mandou para fora, Talbi converteu, Hakimi acertou a trave — e Bounou defendeu a cobrança de Summerville antes de Saibari decidir. Único cartão amarelo: Diop (MAR). Marrocos pega o Canadá nas oitavas.",
          numeros: [
            { v: "1×1", l: "Placar no tempo normal" },
            { v: "3×2", l: "Disputa de pênaltis — vitória marroquina" },
            { v: "1", l: "Defesa decisiva de Bounou na disputa (sobre Summerville)" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Ambas marcam", odd: 1.85, resultado: "hit",
              justificativa: "Gakpo em boa fase pela Holanda, Marrocos com ataque coeso. Ambas confirmaram gol no 1×1." },
            { cat: "conservadora", mercado: "Under 2.5 gols", odd: 1.55, resultado: "hit",
              justificativa: "Jogo de mata-mata tende a ser mais travado. Terminou 1×1, dentro do total baixo." },
            { cat: "conservadora", mercado: "Holanda vence", odd: 1.50, resultado: "miss",
              justificativa: "Holanda favorita pelo histórico recente. Não venceu — empatou e caiu nos pênaltis." },
            { cat: "intermediaria", mercado: "Jogo vai a pênaltis", odd: 4.20, resultado: "hit",
              justificativa: "Confronto equilibrado entre duas seleções organizadas taticamente. Empate em 1×1 levou aos pênaltis." },
            { cat: "intermediaria", mercado: "Cody Gakpo marca", odd: 2.80, resultado: "hit",
              justificativa: "Gakpo como principal referência ofensiva holandesa nesta Copa. Abriu o placar no tempo normal." },
            { cat: "intermediaria", mercado: "Marrocos avança (elimina Holanda)", odd: 3.20, resultado: "hit",
              justificativa: "Marrocos com tradição recente de surpreender em Copas (semifinal em 2022). Confirmado: avançou nos pênaltis." },
            { cat: "loucura", mercado: "Achraf Hakimi perde pênalti na disputa", odd: 6.00, resultado: "hit",
              justificativa: "Disputas de pênaltis são naturalmente imprevisíveis mesmo para cobradores de elite. Hakimi acertou a trave na sua cobrança." },
            { cat: "loucura", mercado: "Yassine Bounou decisivo (defende pênalti)", odd: 5.00, resultado: "hit",
              justificativa: "Bounou (Al-Hilal) como goleiro experiente marroquino. Defendeu a cobrança de Summerville que selou a classificação." },
            { cat: "loucura", mercado: "Jogo termina empatado no tempo normal + Marrocos vence nos pênaltis", odd: 8.00, resultado: "hit",
              justificativa: "Combo de zebra completa que se confirmou integralmente — mais uma disputa dramática de pênaltis nesta fase." }
          ]
        }
      ]
    },
    {
      data: "2026-06-30",
      titulo: "Dia 20 — Haaland decide no fim, Mbappé estraga a festa da Suécia, México sobrevive a expulsão polêmica",
      contexto: "Terceiro dia dos 16-avos com três jogos: Costa do Marfim x Noruega em Dallas (vencedor pega o Brasil nas oitavas), França x Suécia em Nova Jersey e México x Equador no Azteca. Destaque para a expulsão de Piero Hincapié no fim do jogo mexicano, aplicação da nova regra da Fifa (\"Lei Vini Jr\") contra provocação a adversário.",
      jogos: [
        {
          hora: "14h",
          mandante: "Costa do Marfim",
          ...
          local: "AT&T Stadium, Dallas",
          placar: "1 × 2",
          stats: "Jogo de idas e vindas: Nusa abriu o placar para a Noruega ainda no 1T (45'), Amad Diallo empatou para a Costa do Marfim aos 74' do 2T, e Haaland decidiu aos 86' aproveitando sobra na área. Único cartão amarelo: Nusa (NOR), por falta em Guéla Doué. Noruega avança para enfrentar o Brasil nas oitavas de final.",
          numeros: [
            { v: "1×2", l: "Placar final — Noruega decide no fim" },
            { v: "86'", l: "Minuto do gol decisivo de Haaland" },
            { v: "2", l: "Jogos seguidos decididos após os 85 minutos nesta fase" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "Noruega não perde (dupla hipótese)", odd: 1.50, resultado: "hit",
              justificativa: "Noruega com Haaland em grande fase na Copa (4G na fase de grupos). Venceu por 2×1 apesar do sufoco." },
            { cat: "conservadora", mercado: "Over 1.5 gols", odd: 1.55, resultado: "hit",
              justificativa: "Ambas seleções ofensivas na campanha. 3 gols confirmaram o total." },
            { cat: "conservadora", mercado: "Erling Haaland marca", odd: 1.70, resultado: "hit",
              justificativa: "Haaland como principal artilheiro do torneio até aqui. Decidiu aos 86' do 2T." },
            { cat: "intermediaria", mercado: "Noruega vence", odd: 2.00, resultado: "hit",
              justificativa: "Noruega com ataque mais afiado (Haaland, Nusa, Odegaard). Confirmado: 2×1." },
            { cat: "intermediaria", mercado: "Ambas marcam", odd: 1.85, resultado: "hit",
              justificativa: "Costa do Marfim com Diallo e Pépé capazes de criar perigo. Diallo confirmou o gol aos 74'." },
            { cat: "intermediaria", mercado: "Antonio Nusa marca", odd: 3.50, resultado: "hit",
              justificativa: "Nusa surgindo como opção ofensiva importante ao lado de Haaland. Abriu o placar aos 45' do 1T." },
            { cat: "loucura", mercado: "Jogo tem gol depois dos 85 minutos", odd: 2.80, resultado: "hit",
              justificativa: "Jogos de mata-mata tendem a se decidir no fim quando equilibrados. Haaland confirmou aos 86'." },
            { cat: "loucura", mercado: "Amad Diallo marca", odd: 4.50, resultado: "hit",
              justificativa: "Diallo (Manchester United) como principal criador da Costa do Marfim. Empatou aos 74' do 2T." },
            { cat: "loucura", mercado: "Placar muda depois dos 70 minutos", odd: 3.50, resultado: "hit",
              justificativa: "Jogo equilibrado tende a ter reviravoltas no fim. Diallo empatou aos 74' e Haaland decidiu aos 86' — dois gols na reta final." }
          ]
        },
        {
          hora: "18h",
          ...
          placar: "3 × 0",
          stats: "Domínio total da França: Mbappé abriu aos 45' do 1T, Barcola ampliou aos 7' do 2T (assistência de Olise) e Mbappé fechou aos 28' do 2T, também servido por Olise. 53% de posse e 25 finalizações (12 no gol) contra 8 finalizações suecas (3 no gol). Jogo sem nenhum cartão. França encara o Paraguai nas oitavas.",
          numeros: [
            { v: "3×0", l: "Placar final — goleada sem sofrer" },
            { v: "2", l: "Gols de Mbappé na partida" },
            { v: "25", l: "Finalizações da França (12 no gol) contra 8 da Suécia" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "França vence", odd: 1.20, resultado: "hit",
              justificativa: "França como uma das favoritas ao título, muito acima do nível sueco nesta Copa. Goleada por 3×0." },
            { cat: "conservadora", mercado: "França vence a zero", odd: 1.45, resultado: "hit",
              justificativa: "Defesa francesa sólida na campanha. Confirmado clean sheet." },
            { cat: "conservadora", mercado: "Over 2.5 gols", odd: 1.75, resultado: "hit",
              justificativa: "Ataque francês pluriofensivo (Mbappé, Dembélé, Barcola, Olise). 3 gols confirmaram o total." },
            { cat: "intermediaria", mercado: "Kylian Mbappé marca 2+", odd: 3.00, resultado: "hit",
              justificativa: "Mbappé em fase decisiva na Copa. Marcou os gols de abertura e fechamento da partida." },
            { cat: "intermediaria", mercado: "Bradley Barcola marca", odd: 3.50, resultado: "hit",
              justificativa: "Barcola ganhando espaço no ataque francês. Ampliou aos 7' do 2T em bela jogada com Olise." },
            { cat: "intermediaria", mercado: "França vence por 3+", odd: 2.60, resultado: "hit",
              justificativa: "Diferença técnica evidente entre as seleções. Confirmado: vitória por exatos 3 gols de margem." },
            { cat: "loucura", mercado: "Over 3.5 gols", odd: 3.80, resultado: "miss",
              justificativa: "França dominante poderia ter ampliado ainda mais o placar (25 finalizações), mas parou em 3 gols — não passou do total." },
            { cat: "loucura", mercado: "Jogo sem nenhum cartão amarelo", odd: 4.00, resultado: "hit",
              justificativa: "Jogo sem contestação, com domínio técnico claro de um lado. Confirmado: 0 cartões na partida." },
            { cat: "loucura", mercado: "Michael Olise dá assistência", odd: 4.00, resultado: "hit",
              justificativa: "Olise ganhando protagonismo criativo na França. Dá duas assistências: para Barcola e para o 2º gol de Mbappé." }
          ]
        },
        {
          hora: "22h",
          ...
          local: "Estadio Azteca, Cidade do México",
          placar: "2 × 0",
          stats: "México resolveu ainda no 1T: Julián Quiñones (21') e Raúl Jiménez (30') marcaram após boa triangulação ofensiva. Nos acréscimos do 2T (49'), Piero Hincapié foi expulso por colocar a mão na boca durante discussão com Santiago Giménez — aplicação da nova diretriz da Fifa contra provocação, revisada pelo árbitro esloveno Slavko Vincic no VAR. Amarelos para Alan Franco, Kendry Páez e Moisés Caicedo (Equador). México encara o Paraguai nas oitavas de final.",
          numeros: [
            { v: "2×0", l: "Placar final — México resolve no 1º tempo" },
            { v: "49'", l: "Minuto da expulsão de Hincapié nos acréscimos do 2T" },
            { v: "40 anos", l: "Jejum de vitórias em mata-mata de Copa que o México quebrou" }
          ],
          dicas: [
            { cat: "conservadora", mercado: "México vence", odd: 1.65, resultado: "hit",
              justificativa: "México como sede jogando em casa no Azteca, favorito claro. Venceu por 2×0." },
            { cat: "conservadora", mercado: "México marca no 1T", odd: 1.50, resultado: "hit",
              justificativa: "Quiñones e Jiménez resolveram ainda na etapa inicial (21' e 30')." },
            { cat: "conservadora", mercado: "Under 2.5 gols", odd: 1.55, resultado: "hit",
              justificativa: "Jogo de mata-mata tende a ser mais cauteloso após abertura de vantagem. Terminou 2×0." },
            { cat: "intermediaria", mercado: "México vence a zero", odd: 2.00, resultado: "hit",
              justificativa: "Defesa mexicana segura após abrir vantagem cedo. Confirmado clean sheet." },
            { cat: "intermediaria", mercado: "Raúl Jiménez marca", odd: 2.80, resultado: "hit",
              justificativa: "Jiménez como principal centroavante mexicano. Ampliou aos 30' do 1T." },
            { cat: "intermediaria", mercado: "Julián Quiñones marca", odd: 3.00, resultado: "hit",
              justificativa: "Quiñones em bom momento na campanha de grupos. Abriu o placar aos 21' do 1T." },
            { cat: "loucura", mercado: "Jogo tem expulsão", odd: 4.50, resultado: "hit",
              justificativa: "Jogos de mata-mata com ânimos exaltados no fim aumentam o risco de expulsão. Confirmado: Hincapié expulso nos acréscimos." },
            { cat: "loucura", mercado: "Piero Hincapié recebe cartão vermelho", odd: 8.00, resultado: "hit",
              justificativa: "Mercado hiperespecífico que se confirmou: Hincapié expulso por gesto de provocação, primeira aplicação de peso da nova regra da Fifa nesta Copa." },
            { cat: "loucura", mercado: "México vence a zero + jogo tem expulsão", odd: 6.00, resultado: "hit",
              justificativa: "Combo que uniu o resultado esperado (vitória mexicana sem sofrer) com o imprevisível (expulsão por provocação). Ambos se confirmaram." }
          ]
        }
      ]
    },
    {
      data: "2026-07-01",
      titulo: "Dia 21 — Duelo de artilheiros em Atlanta, zebra possível em Seattle, Dzeko busca a despedida perfeita",
      contexto: "Terceiro dia dos 16-avos com três jogos. Inglaterra (100% na fase de grupos, sem sofrer virada) encara a estreante histórica RD Congo (52 anos sem Copa) em Atlanta — duelo particular entre Kane e Wissa, ambos com 3 gols no torneio. Em Seattle, Bélgica busca embalar após a goleada sobre a Nova Zelândia contra o Senegal, que se recuperou de duas derrotas para golear o Iraque e entrar como um dos melhores terceiros — o modelo Elo-Poisson, após o reajuste da rodada, favorece ligeiramente o Senegal. À noite, em Santa Clara, os EUA (donos da casa, com Pulisic recuperado de lesão na panturrilha) tentam parar a Bósnia de Edin Dzeko, aos 40 anos, disputando provavelmente sua última Copa.",
      jogos: [
        {
          hora: "13h",
          mandante: "Inglaterra",
